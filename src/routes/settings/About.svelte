<script>
  ...
  import { isNative, iconUrl } from '../../lib/platform.js';
</script>
...
<style>
  ...
  .about-name { font-weight: 700; font-size: 16px; color: var(--text-1); }
  .about-version { display: flex; align-items: center; gap: 8px; margin-top: 2px; }
  .platform-tag {
