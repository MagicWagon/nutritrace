<script>
  ...
  const ALL_METRICS = [
    ...
    // Heart — Fitbit only
    { id: 'skin_temp_variation', label: 'Skin Temp Var.', unit: '°C',   group: 'heart', icon: 'thermometer',    fmt: v => (v >= 0 ? '+' : '') + v.toFixed(2), sources: ['fitbit'], desc: 'Nightly skin temperature variation from your personal baseline. Elevated readings can indicate illness or hormonal changes.' },
