...
router.put('/password-login', wrap((req, res) => {
  ...
  // in the environment. Returning 403 (not 400) mirrors how other env-locked
  // settings behave and gives the admin UI a stable signal to disable the
  // toggle without needing to poll the env-locks endpoint again.
